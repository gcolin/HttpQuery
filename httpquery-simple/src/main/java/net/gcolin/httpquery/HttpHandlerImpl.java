...
public class HttpHandlerImpl implements HttpHandler {
    ...
    public Request put(String uri, byte[] data) {
        return new RequestWithPayloadImpl(PUT_METHOD,uri,data)
        .serialize();
    }

    @Override
    public Request put(String uri, String str) {
        return new RequestWithPayloadImpl(PUT_METHOD,uri,str)
        .serialize();
    }
    ...
    public Request post(String uri, InputStream inStream) {
        return new RequestWithPayloadImpl(POST_METHOD,uri,inStream).serialize();
    }
