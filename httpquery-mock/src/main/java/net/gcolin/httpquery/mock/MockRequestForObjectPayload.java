...
public class MockRequestForObjectPayload {
    ...
    public MockRequestForObjectPayload(String method, String uri,
            Object payload,
    ...
    public MockRequestForObjectPayload deserializeWith(
            Class<? extends Deserializer> p) {
        deserializer = p;
        return this;
    }
    ...
    protected void add(RequestWithPayloadImpl r) {
        try {
            ...
            Map<Item<String, Object>, RequestWithPayload> map = (Map<Item<String, Object>, RequestWithPayload>) getter()
                    .invoke(MockHttpHandler.getInstance());
            map.put(new Item<String, Object>(uri, payload),
                    (RequestWithPayload) r);
        } catch (Exception e) {
    ...
    protected RequestWithPayloadImpl get() {
        try {
            ...
            Map<Item<String, Object>, RequestWithPayload> map = (Map<Item<String, Object>, RequestWithPayload>) getter()
                    .invoke(MockHttpHandler.getInstance());
            RequestWithPayload r = map.get(new Item<String, Object>(uri,
                    payload));
            if (r != null) {
